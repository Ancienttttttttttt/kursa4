...
namespace K4 {
    ...
    public partial class Kursa4DataSet10 : global::System.Data.DataSet {
        ...
        public partial class SotrudnikiDataTable : global::System.Data.TypedTableBase<SotrudnikiRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public SotrudnikiRow AddSotrudnikiRow(string Фамилия, string Имя, string Отчество, string Должность, string Телефон, int НомерОтдела, string Логин, string Пароль) {
...
namespace K4.Kursa4DataSet10TableAdapters {
    ...
    public partial class SotrudnikiTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Sotrudniki] WHERE (([НомерСотрудника] = @Original_НомерСотрудника) AND ((@IsNull_Фамилия = 1 AND [Фамилия] IS NULL) OR ([Фамилия] = @Original_Фамилия)) AND ((@IsNull_Имя = 1 AND [Имя] IS NULL) OR ([Имя] = @Original_Имя)) AND ((@IsNull_Отчество = 1 AND [Отчество] IS NULL) OR ([Отчество] = @Original_Отчество)) AND ((@IsNull_Должность = 1 AND [Должность] IS NULL) OR ([Должность] = @Original_Должность)) AND ((@IsNull_Телефон = 1 AND [Телефон] IS NULL) OR ([Телефон] = @Original_Телефон)) AND ((@IsNull_НомерОтдела = 1 AND [НомерОтдела] IS NULL) OR ([НомерОтдела] = @Original_НомерОтдела)) AND ((@IsNull_Логин = 1 AND [Логин] IS NULL) OR ([Логин] = @Original_Логин)) AND ((@IsNull_Пароль = 1 AND [Пароль] IS NULL) OR ([Пароль] = @Original_Пароль)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Sotrudniki] ([Фамилия], [Имя], [Отчество], [Должность], [Телефон], [НомерОтдела], [Логин], [Пароль]) VALUES (@Фамилия, @Имя, @Отчество, @Должность, @Телефон, @НомерОтдела, @Логин, @Пароль);
SELECT НомерСотрудника, Фамилия, Имя, Отчество, Должность, Телефон, НомерОтдела, Логин, Пароль FROM Sotrudniki WHERE (НомерСотрудника = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Sotrudniki] SET [Фамилия] = @Фамилия, [Имя] = @Имя, [Отчество] = @Отчество, [Должность] = @Должность, [Телефон] = @Телефон, [НомерОтдела] = @НомерОтдела, [Логин] = @Логин, [Пароль] = @Пароль WHERE (([НомерСотрудника] = @Original_НомерСотрудника) AND ((@IsNull_Фамилия = 1 AND [Фамилия] IS NULL) OR ([Фамилия] = @Original_Фамилия)) AND ((@IsNull_Имя = 1 AND [Имя] IS NULL) OR ([Имя] = @Original_Имя)) AND ((@IsNull_Отчество = 1 AND [Отчество] IS NULL) OR ([Отчество] = @Original_Отчество)) AND ((@IsNull_Должность = 1 AND [Должность] IS NULL) OR ([Должность] = @Original_Должность)) AND ((@IsNull_Телефон = 1 AND [Телефон] IS NULL) OR ([Телефон] = @Original_Телефон)) AND ((@IsNull_НомерОтдела = 1 AND [НомерОтдела] IS NULL) OR ([НомерОтдела] = @Original_НомерОтдела)) AND ((@IsNull_Логин = 1 AND [Логин] IS NULL) OR ([Логин] = @Original_Логин)) AND ((@IsNull_Пароль = 1 AND [Пароль] IS NULL) OR ([Пароль] = @Original_Пароль)));
SELECT НомерСотрудника, Фамилия, Имя, Отчество, Должность, Телефон, НомерОтдела, Логин, Пароль FROM Sotrudniki WHERE (НомерСотрудника = @НомерСотрудника)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT НомерСотрудника, Фамилия, Имя, Отчество, Должность, Телефон, НомерОтдела, " +
                "Логин, Пароль FROM dbo.Sotrudniki";
        ...
        public virtual int Fill(Kursa4DataSet10.SotrudnikiDataTable dataTable) {
        ...
        public virtual Kursa4DataSet10.SotrudnikiDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Kursa4DataSet10.SotrudnikiDataTable dataTable = new Kursa4DataSet10.SotrudnikiDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Kursa4DataSet10.SotrudnikiDataTable dataTable) {
        ...
        public virtual int Delete(int Original_НомерСотрудника, string Original_Фамилия, string Original_Имя, string Original_Отчество, string Original_Должность, string Original_Телефон, global::System.Nullable<int> Original_НомерОтдела, string Original_Логин, string Original_Пароль) {
            ...
            if ((Original_НомерОтдела.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[12].Value = ((int)(Original_НомерОтдела.Value));
            }
            else {
            ...
            if ((Original_Логин == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[14].Value = ((string)(Original_Логин));
            }
        ...
        public virtual int Insert(string Фамилия, string Имя, string Отчество, string Должность, string Телефон, global::System.Nullable<int> НомерОтдела, string Логин, string Пароль) {
            if ((Фамилия == null)) {
            ...
            if ((НомерОтдела.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[5].Value = ((int)(НомерОтдела.Value));
            }
            else {
        ...
        public virtual int Update(
            ...
            if ((НомерОтдела.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(НомерОтдела.Value));
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_НомерСотрудника));
            if ((Original_Фамилия == null)) {
            ...
            if ((Original_НомерОтдела.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[20].Value = ((int)(Original_НомерОтдела.Value));
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[25].Value = ((int)(НомерСотрудника));
        ...
        public virtual int Update(
                    ...
                    string Original_Логин, 
                    string Original_Пароль) {
            return this.Update(Фамилия, Имя, Отчество, Должность, Телефон, НомерОтдела, Логин, Пароль, Original_НомерСотрудника, Original_Фамилия, Original_Имя, Original_Отчество, Original_Должность, Original_Телефон, Original_НомерОтдела, Original_Логин, Original_Пароль, Original_НомерСотрудника);
        }
    }
