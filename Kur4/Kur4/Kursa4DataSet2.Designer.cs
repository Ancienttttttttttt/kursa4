...
namespace Kur4 {
    ...
    public partial class Kursa4DataSet2 : global::System.Data.DataSet {
        ...
        public partial class SotrudnikiDataTable : global::System.Data.TypedTableBase<SotrudnikiRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public SotrudnikiRow AddSotrudnikiRow(string Фамилия, string Имя, string Отчество, string Должность, string Телефон, int НомерОтдела) {
...
namespace Kur4.Kursa4DataSet2TableAdapters {
    ...
    public partial class SotrudnikiTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Sotrudniki] WHERE (([НомерСотрудника] = @Original_НомерСотрудника) AND ((@IsNull_Фамилия = 1 AND [Фамилия] IS NULL) OR ([Фамилия] = @Original_Фамилия)) AND ((@IsNull_Имя = 1 AND [Имя] IS NULL) OR ([Имя] = @Original_Имя)) AND ((@IsNull_Отчество = 1 AND [Отчество] IS NULL) OR ([Отчество] = @Original_Отчество)) AND ((@IsNull_Должность = 1 AND [Должность] IS NULL) OR ([Должность] = @Original_Должность)) AND ((@IsNull_Телефон = 1 AND [Телефон] IS NULL) OR ([Телефон] = @Original_Телефон)) AND ((@IsNull_НомерОтдела = 1 AND [НомерОтдела] IS NULL) OR ([НомерОтдела] = @Original_НомерОтдела)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Sotrudniki] ([Фамилия], [Имя], [Отчество], [Должность], [Телефон], [НомерОтдела]) VALUES (@Фамилия, @Имя, @Отчество, @Должность, @Телефон, @НомерОтдела);
SELECT НомерСотрудника, Фамилия, Имя, Отчество, Должность, Телефон, НомерОтдела FROM Sotrudniki WHERE (НомерСотрудника = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Sotrudniki] SET [Фамилия] = @Фамилия, [Имя] = @Имя, [Отчество] = @Отчество, [Должность] = @Должность, [Телефон] = @Телефон, [НомерОтдела] = @НомерОтдела WHERE (([НомерСотрудника] = @Original_НомерСотрудника) AND ((@IsNull_Фамилия = 1 AND [Фамилия] IS NULL) OR ([Фамилия] = @Original_Фамилия)) AND ((@IsNull_Имя = 1 AND [Имя] IS NULL) OR ([Имя] = @Original_Имя)) AND ((@IsNull_Отчество = 1 AND [Отчество] IS NULL) OR ([Отчество] = @Original_Отчество)) AND ((@IsNull_Должность = 1 AND [Должность] IS NULL) OR ([Должность] = @Original_Должность)) AND ((@IsNull_Телефон = 1 AND [Телефон] IS NULL) OR ([Телефон] = @Original_Телефон)) AND ((@IsNull_НомерОтдела = 1 AND [НомерОтдела] IS NULL) OR ([НомерОтдела] = @Original_НомерОтдела)));
SELECT НомерСотрудника, Фамилия, Имя, Отчество, Должность, Телефон, НомерОтдела FROM Sotrudniki WHERE (НомерСотрудника = @НомерСотрудника)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT НомерСотрудника, Фамилия, Имя, Отчество, Должность, Телефон, НомерОтдела F" +
                "ROM dbo.Sotrudniki";
        ...
        public virtual int Delete(int Original_НомерСотрудника, string Original_Фамилия, string Original_Имя, string Original_Отчество, string Original_Должность, string Original_Телефон, global::System.Nullable<int> Original_НомерОтдела) {
        ...
        public virtual int Insert(string Фамилия, string Имя, string Отчество, string Должность, string Телефон, global::System.Nullable<int> НомерОтдела) {
            if ((Фамилия == null)) {
        ...
        public virtual int Update(string Фамилия, string Имя, string Отчество, string Должность, string Телефон, global::System.Nullable<int> НомерОтдела, int Original_НомерСотрудника, string Original_Фамилия, string Original_Имя, string Original_Отчество, string Original_Должность, string Original_Телефон, global::System.Nullable<int> Original_НомерОтдела, int НомерСотрудника) {
            if ((Фамилия == null)) {
            ...
            if ((Original_НомерОтдела.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[18].Value = ((int)(Original_НомерОтдела.Value));
            }
            else {
                this.Adapter.UpdateCommand.Parameters[17].Value = ((object)(1));
                this.Adapter.UpdateCommand.Parameters[18].Value = global::System.DBNull.Value;
            }
            this.Adapter.UpdateCommand.Parameters[19].Value = ((int)(НомерСотрудника));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Фамилия, string Имя, string Отчество, string Должность, string Телефон, global::System.Nullable<int> НомерОтдела, int Original_НомерСотрудника, string Original_Фамилия, string Original_Имя, string Original_Отчество, string Original_Должность, string Original_Телефон, global::System.Nullable<int> Original_НомерОтдела) {
            return this.Update(Фамилия, Имя, Отчество, Должность, Телефон, НомерОтдела, Original_НомерСотрудника, Original_Фамилия, Original_Имя, Original_Отчество, Original_Должность, Original_Телефон, Original_НомерОтдела, Original_НомерСотрудника);
        }
    }
