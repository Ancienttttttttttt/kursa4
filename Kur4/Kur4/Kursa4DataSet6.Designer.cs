...
namespace Kur4.Kursa4DataSet6TableAdapters {
...
SELECT НомерСотрудника, Фамилия, Имя, Отчество, Должность, Телефон, НомерОтдела, Логин, Пароль FROM Sotrudniki WHERE (НомерСотрудника = @НомерСотрудника)";
        ...
        public virtual int Fill(Kursa4DataSet6.SotrudnikiDataTable dataTable) {
        ...
        public virtual Kursa4DataSet6.SotrudnikiDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Kursa4DataSet6.SotrudnikiDataTable dataTable = new Kursa4DataSet6.SotrudnikiDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Kursa4DataSet6.SotrudnikiDataTable dataTable) {
